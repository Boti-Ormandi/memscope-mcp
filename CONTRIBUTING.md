...
- [`memscope_mcp/scanning/`](memscope_mcp/scanning/) -- internal strict scan contracts, compiler, hybrid matcher, and bounded result collectors (not a supported public Python API)
